...
// ✅ VERSIÓN COMPLETA CON LOGS DE DEPURACIÓN
...
export const RouteMap = () => {
  ...
  // ✅ handlePointClick CON LOGS
  const handlePointClick = (point) => {
    console.log('🔄 [RouteMap] handlePointClick llamado con:', point.id);
    console.log('🔄 [RouteMap] punto completo:', point);
          ...
          return (
            <Marker
              ...
              eventHandlers={{
                click: (e) => {
                  L.DomEvent.stopPropagation(e);
                  console.log('🔄 [RouteMap] Click en marcador:', point.id);
